        ...
        <div class="col-12">
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    ...
                    <p class="text-white-50 mb-0">Daftarkan petugas baru ke dalam sistem</p>
                </div>
                <div>
        ...
        <div class="col-lg-8 mx-auto">
            <div class="card">
                <div class="card-header pb-0">
                    <h6>Form Pendaftaran Petugas</h6>
                    <p class="text-sm mb-0">Lengkapi data petugas di bawah ini</p>
                </div>
                <div class="card-body">
                    @if ($errors->any())
                    ...
                    <form action="{{ route('admin.petugas.store') }}" method="POST">
                        ...
                        <div class="alert alert-info mb-3">
                            ...
                            <strong>Catatan:</strong> Setelah didaftarkan, petugas dapat login menggunakan email dan password yang telah ditentukan.
                        </div>
