...
@section('title', 'Buat Laporan Baru - Sistem Pertanian')
        ...
        <div class="col-12">
            <div class="content-card">
                <div class="card-header-agriculture">
                    <h4><i class="fas fa-plus me-2"></i>Buat Laporan Hasil Panen Baru</h4>
                    <p class="mb-0 text-muted">Laporkan kemajuan dan hasil panen Anda</p>
                </div>
                <div class="card-body">
                    <form action="{{ route('guest.laporan.store') }}" method="POST">
                        @csrf
                            ...
                            <div class="col-md-8">
                                ...
                                <div class="form-group mb-4">
                                    ...
                                    <input type="text" class="form-control form-control-agriculture @error('nama_petani') is-invalid @enderror"
                                           name="nama_petani" id="nama_petani" value="{{ old('nama_petani') }}"
                                ...
                                <div class="form-group mb-4">
                                    ...
                                    <input type="text" class="form-control form-control-agriculture @error('alamat_desa') is-invalid @enderror"
                                           name="alamat_desa" id="alamat_desa" value="{{ old('alamat_desa') }}"
                                ...
                                <div class="form-group mb-4">
                                    ...
                                    <textarea class="form-control form-control-agriculture @error('deskripsi_kemajuan') is-invalid @enderror"
                                              ...
                                              placeholder="Jelaskan kemajuan pertanian Anda hari ini..." required>{{ old('deskripsi_kemajuan') }}</textarea>
                                ...
                                <div class="form-group mb-4">
                                    ...
                                    <select class="form-select form-select-agriculture @error('jenis_tanaman') is-invalid @enderror"
                                        ...
                                        <option value="Singkong" {{ old('jenis_tanaman') == 'Singkong' ? 'selected' : '' }}>🥔 Singkong</option>
                                ...
                                <div class="form-group mb-4">
                                    ...
                                    <input type="number" class="form-control form-control-agriculture @error('hasil_panen') is-invalid @enderror"
                                           ...
                                           value="{{ old('hasil_panen', 0) }}" placeholder="0.00" required>
                                    @error('hasil_panen')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="form-group mb-4">
                                    ...
                                    <input type="number" class="form-control form-control-agriculture @error('luas_lahan') is-invalid @enderror"
                                           ...
                                           value="{{ old('luas_lahan') }}" placeholder="0.00" required>
                                    @error('luas_lahan')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="card border-agriculture mb-4">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="info-item">
                                            ...
                                            Laporan ini akan disimpan sebagai laporan dari guest
                                        </div>
                                    </div>
                                </div>
