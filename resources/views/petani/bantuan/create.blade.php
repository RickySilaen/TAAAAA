...
<div class="frm-container">
    <div class="frm-header-card">
        <div class="d-flex align-items-center">
            ...
            <div>
                <h1>Ajukan Permintaan Bantuan</h1>
                <p>Isi formulir untuk mengajukan bantuan pertanian</p>
            </div>
        </div>
    </div>
    ...
    <div class="frm-card">
        <div class="frm-card-header">
            ...
            <h5>Formulir Pengajuan Bantuan</h5>
        </div>
        <div class="frm-card-body">
            <form action="{{ route('petani.bantuan.store') }}" method="POST">
                @csrf
                ...
                <div class="frm-group">
                    ...
                    <select class="frm-select @error('jenis_bantuan') is-invalid @enderror" name="jenis_bantuan" required>
                        ...
                        <option value="Dana" {{ old('jenis_bantuan') == 'Dana' ? 'selected' : '' }}>💰 Dana</option>
                ...
                <div class="frm-group">
                    ...
                    <input type="number" class="frm-control @error('jumlah') is-invalid @enderror" 
                           name="jumlah" value="{{ old('jumlah') }}" required min="1" placeholder="Masukkan jumlah...">
                    @error('jumlah')
                        <div class="frm-error">{{ $message }}</div>
                    @enderror
                ...
                <div class="frm-group">
                    ...
                    <input type="date" class="frm-control @error('tanggal_permintaan') is-invalid @enderror" 
                           name="tanggal_permintaan" value="{{ old('tanggal_permintaan', date('Y-m-d')) }}">
                ...
                <div class="frm-group">
                    ...
                    <textarea class="frm-textarea @error('keterangan') is-invalid @enderror" 
                              name="keterangan" placeholder="Jelaskan alasan Anda mengajukan bantuan ini...">{{ old('keterangan') }}</textarea>
                    @error('keterangan')
                        <div class="frm-error">{{ $message }}</div>
                    @enderror
